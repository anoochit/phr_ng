...
const SettingSchema = CollectionSchema(
  ...
  properties: {
    r'locale': PropertySchema(
      ...
      name: r'locale',
      type: IsarType.byte,
      enumMap: _SettinglocaleEnumValueMap,
    ),
    r'theme': PropertySchema(
      id: 1,
      name: r'theme',
      type: IsarType.byte,
      enumMap: _SettingthemeEnumValueMap,
    )
  },
...
const _SettinglocaleEnumValueMap = {
  'enUS': 0,
  'thTH': 1,
};
...
extension SettingQuerySortBy on QueryBuilder<Setting, Setting, QSortBy> {
  QueryBuilder<Setting, Setting, QAfterSortBy> sortByLocale() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'locale', Sort.asc);
    });
  }

  QueryBuilder<Setting, Setting, QAfterSortBy> sortByLocaleDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SettingQuerySortThenBy
  ...
  QueryBuilder<Setting, Setting, QAfterSortBy> thenByLocale() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'locale', Sort.asc);
    });
  }

  QueryBuilder<Setting, Setting, QAfterSortBy> thenByLocaleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'locale', Sort.desc);
    });
  }
...
extension SettingQueryWhereDistinct
  ...
  QueryBuilder<Setting, Setting, QDistinct> distinctByLocale() {
    return QueryBuilder.apply(this, (query) {
